1. langchain tutorial repo - https://github.com/langchain-ai/rag-from-scratch
2. yarik zagotovki - https://github.com/Pretzandalf/Vseros_pamyatka/tree/main
...
nvidia-smi -i 0
```
Напиши в терминале, чтобы узнать статистику по домашнему майнеру
